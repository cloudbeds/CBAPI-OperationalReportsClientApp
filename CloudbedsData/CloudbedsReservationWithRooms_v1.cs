...
/// </summary>
class CloudbedsReservationWithRooms_v1
{
    ...
    public readonly IReadOnlyCollection<CloudbedsReservationRoom_v1> ReservationRooms;
    ...
    public CloudbedsReservationWithRooms_v1(
        ...
        string guestId,
        string guestName,
        ICollection<CloudbedsReservationRoom_v1> reservationRooms
        )
    {
...
//        this.Reservation_Children = reservationChildren;
        ...
        this.ReservationRooms = new List<CloudbedsReservationRoom_v1>(reservationRooms).AsReadOnly();
