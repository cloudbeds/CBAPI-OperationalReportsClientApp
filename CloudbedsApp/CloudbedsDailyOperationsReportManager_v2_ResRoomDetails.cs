...
using System.Web;
using static CloudbedsDailyOperationsReportManager_v2;
...
internal partial class CloudbedsDailyOperationsReportManager_v2_ResRoomDetails
{
    ...
    public CloudbedsDailyOperationsReportManager_v2_ResRoomDetails(DateTime dateStart, DateTime dateEnd,
        ICollection<CloudbedsReservationWithRooms_v2> reservationSet)
    {
    ...
    /// <returns></returns>
    private static string helper_GenerateStateStateForDate(DateTime date, CloudbedsReservationRoom_v2 subReservation)
    {
    ...
    /// <param name="reservationSet"></param>
    /// <returns></returns>
    private List<DailyReportSet> GenerateDateRangeReportSet(DateTime dateStart, DateTime dateEnd, ICollection<CloudbedsReservationWithRooms_v2> reservationSet)
    {
    ...
    /// <param name="reservationSet"></param>
    /// <returns></returns>
    private DailyReportSet GenerateDailyReportSet_SingleDate(DateTime dateTarget, ICollection<CloudbedsReservationWithRooms_v2> reservationSet)
    {
        List<CloudbedsReservationRoom_v2> outputSetOfSubReservation = new List<CloudbedsReservationRoom_v2>();
        //============================================================================
    ...
    private void helper_addSubReservationsWithIntersectingDates(DateTime dateTarget, List<CloudbedsReservationRoom_v2> appendTo_subReservations, CloudbedsReservationWithRooms_v2 thisReservation)
    {
    ...
    /// <param name="appendTo_subReservations"></param>
    private void helper_addSubReservationsWithIntersectingDates_subReservation(DateTime dateTarget, CloudbedsReservationRoom_v2 thisSubReservation, List<CloudbedsReservationRoom_v2> appendTo_subReservations)
    {
