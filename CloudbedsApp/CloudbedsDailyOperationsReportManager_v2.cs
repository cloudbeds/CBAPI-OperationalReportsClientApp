...
internal  partial class CloudbedsDailyOperationsReportManager_v2
{
    ...
    public CloudbedsDailyOperationsReportManager_v2(DateTime dateStart, DateTime dateEnd, 
    ...
    /// <param name="reservationSet"></param>
    /// <returns></returns>
    private List<DailyReport> GenerateDailyReportSet (DateTime dateStart, DateTime dateEnd, ICollection<CloudbedsReservationWithRooms_v2> reservationSet)
    {
    ...
    /// <param name="reservationSet"></param>
    /// <returns></returns>
    private DailyReport GenerateDailyReportSet_SingleDate(DateTime dateTarget, ICollection<CloudbedsReservationWithRooms_v2> reservationSet)
    {
        int numCheckIns = 0;
    ...
    private CheckInsInfo DateCheck_CalculateNumberForReservation_CheckIns(DateTime dateTarget, CloudbedsReservationWithRooms_v2 thisReservation)
    {
        ...
        foreach(var thisRoom in thisReservation.ReservationRooms)
        {
            ...
            if(thisRoom.Room_Status != CloudbedsReservationRoom_v2.RoomStatus_Cancelled)
            {
    ...
    /// <returns></returns>
    /// <exception cref="NotImplementedException"></exception>
    private CheckOutsInfo DateCheck_CalculateNumberForReservation_CheckOuts(DateTime dateTarget, CloudbedsReservationWithRooms_v2 thisReservation)
    {
        //If it is canceleld, ignore it
        if (thisReservation.Reservation_Status == CloudbedsReservationStatus.STATUS_CANCELED)
        {
    ...
    /// <returns></returns>
    /// <exception cref="NotImplementedException"></exception>
    private int DateCheck_CalculateNumberForReservation_Stayovers(DateTime compareDate, CloudbedsReservationWithRooms_v2 thisReservation)
    {
        //If it is canceleld, ignore it
        if (thisReservation.Reservation_Status == CloudbedsReservationStatus.STATUS_CANCELED)
        {
