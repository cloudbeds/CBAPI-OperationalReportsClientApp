...
/// </summary>
partial class CloudbedsReservationManager_v1
{
    ...
    {
        public readonly Dictionary<string, CloudbedsReservation_v1> Items;
        public readonly DateTime LastUpdatedUtc;

        public CachedData(Dictionary<string, CloudbedsReservation_v1> items, DateTime updatedUtc)
        {
            this.Items = items;
    ...
    public ICollection<CloudbedsReservation_v1> Reservations
    {
        get 
        { 
            if(_cachedData == null)
    ...
    /// <returns></returns>
    internal CloudbedsReservation_v1 FindGuestWithId(string reservationId)
    {
        EnsureCachedData();

        CloudbedsReservation_v1 reservationOut;
    ...
    public CloudbedsReservationManager_v1(
    ...
    */
    ...
    /// <returns></returns>
    /// <exception cref="Exception"></exception>
    private Dictionary<string, CloudbedsReservation_v1> helper_SynchronouEnsureCloudbedsData()
    {
        //The set to store all of our results...
        var buildSet = new Dictionary<string, CloudbedsReservation_v1>();
    ...
    /// <exception cref="Exception"></exception>
    private void helper_queryAndAppendReservations(Dictionary<string, CloudbedsReservation_v1> buildSet, string reservationStatus)
    {
        //==========================================================================
    ...
    private void helper_appendUniqueItemsToDictionary(Dictionary<string, CloudbedsReservation_v1> buildSet, ICollection<CloudbedsReservation_v1> appendReservations)
    {
        //Sanity test
